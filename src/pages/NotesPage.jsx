import { Box, Button, FormLabel, Grid, IconButton, Input, Textarea, useDisclosure } from "@chakra-ui/react";
...
export default function NotesPage() {
  ...
  const createNote =()=>{
    Swal.fire({
      position: 'center',
      icon: 'success',
      title: 'Your Notes has been saved',
      showConfirmButton: false,
      timer: 1500
    })
    dispatch(createNotes({title,body,color}))
    setTitle("")
    setBody("")
    setColor("")
    onClose()
        ...
        >
          ...
          <ModalContent>
            ...
            <ModalBody pb={6}>
                ...
                <Input value={color} type="color" onChange={(e)=>{setColor(e.target.value)}}></Input>
